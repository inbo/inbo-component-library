import {Component, ContentChild, input, model, TemplateRef, ViewEncapsulation,} from '@angular/core';
...
} from '../../directives/debounced-input-change/inbo-debounced-input-change.directive';
...
> implements ControlValueAccessor {
    ...
    @ContentChild('selectedTemplate', {read: TemplateRef}) selectedTemplate?: TemplateRef<any>;
